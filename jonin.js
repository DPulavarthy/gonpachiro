...
client.on(`ready`, async () => { client.src.startup([client, new MongoClient(`mongodb://txj69.xyz:27017/?readPreference=primary&appname=MongoDB%20Compass&ssl=false`, { useUnifiedTopology: true })]); }); // Start-up Function
...
client.on(`guildMemberRemove`, async member => { client.function.memberRemove(member) });
